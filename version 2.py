...
def hanoi(n, quelle, ziel, hilfe):
    # Verwende einen Stack um die Bewegungen zu speichern
    bewegungen = []
    
    # Initialisiere den Stack mit dem ersten Aufruf
    ...
    while bewegungen:
        ...
        if scheiben == 1:
            print(f"Bewege Scheibe 1 von {q} nach {z}")
        else:
            # Füge die Bewegungen in umgekehrter Reihenfolge hinzu
            bewegungen.append((scheiben-1, h, z, q))  # Schritt 3
            bewegungen.append((1, q, z, h))           # Schritt 2
            bewegungen.append((scheiben-1, q, h, z))  # Schritt 1
