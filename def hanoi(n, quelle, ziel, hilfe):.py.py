...
if __name__ == "__main__":
    ...
    def hanau_mit_visual(n, quelle, ziel, hilfe):
        ...
        def hanau_rekursiv(n, quelle, ziel, hilfe):
    ...
    if __name__ == "__main__":
        ...
        hanau_mit_visual(anzahl_scheiben, 'A', 'C', 'B')
